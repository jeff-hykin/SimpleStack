def SystemRoutes(): #this is name-specific
    ...
    def page_route2():
        file = open('/Users/jeffhykin/Documents/_Programming/SimpleStack/.Server/boilerplate/static/Home→Home.page.js', "r")
        output = file.read()
        file.close()
        return output
    ...
    def module_route3():
        file = open('/Users/jeffhykin/Documents/_Programming/SimpleStack/.Server/boilerplate/static/Home→blah.module.js', "r")
        output = file.read()
        file.close()
        return output
